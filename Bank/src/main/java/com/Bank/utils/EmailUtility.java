...
public class EmailUtility {
    ...
    private static final String EMAIL_FROM = "nathanyasiphorac_cse21@velhightech.com";
    private static final String EMAIL_PASSWORD = "computer";

    public static void sendEmail(String emailId, String accountNumber, String tempPassword) {
    ...
    public static void rejectEmail(String emailId) {
